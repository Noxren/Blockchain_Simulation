...
##use RSA encryption to randomly genarate a pair of public key and private key
import rsa
...
class BlockChain:
    ...
    def create_genesis_block(self):
        ...
        new_block = Block('Hello World!', self.difficulty, 'noxren', self.miner_rewards)
...
##test verify blockchain
##if __name__ == '__main__':
##    block = BlockChain()
##    block.create_genesis_block()
##   block.mine_block('noxren')
